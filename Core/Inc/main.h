...
#define DOOR_SENS_Pin GPIO_PIN_10
#define DOOR_SENS_GPIO_Port GPIOB
#define DOOR_LOCK_Pin GPIO_PIN_8
#define DOOR_LOCK_GPIO_Port GPIOA
#define EN_CHARGE_Pin GPIO_PIN_10
...
#define LED_CHARGE_Pin GPIO_PIN_4
#define LED_CHARGE_GPIO_Port GPIOB
#define LED_FULL_Pin GPIO_PIN_5
